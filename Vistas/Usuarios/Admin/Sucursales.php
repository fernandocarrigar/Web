    ...
    <div class="container-fluid d-inline-flex">
        ...
        <div class="container d-flex col-5 rounded-3 p-0 bg-white rounded shadow-lg" style="max-height:520px;">
            <div class="overflow-y-auto table-scroll">
                ...
                ?>
                    <li class="nav-item mb-2"><button type="button" onclick="myLocation(<?php echo $rows['Longitud']?>,<?php echo $rows['Latitud']?>,<?php echo $rows['Sucursal']?>,<?php echo $rows['Direccion']?>)" class="btn btn-outline-dark btn-sm m-0 h-100 w-100 overflow-auto"><p class="text-start fs-6 fw-bold m-0"><?php echo $rows['Sucursal'] ?></p><p class="text-start"><?php echo $rows['Direccion'] ?></p></button></li>
                <?php
                endforeach;
                ?>
                </ul>
