...
<div class="offcanvas offcanvas-start text-bg-white" id="demo">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
            <li class="nav-item">
                <a class="nav-link text-black active" aria-current="page" href="index.php?page=Edicion&form=BGLOGO">Colores y Logo de la pagina</a>
            </li>
            <li class="nav-item">
...
<!-- Titulo de la vista -->
    ...
    if((!empty($dtpubwhere)) && (isset($dtpubwhere))){
        ?>
            <form method="post" action="index.php?page=Edicion&actionpub=update&Id=<?php echo $Id ?>&Seccion=<?php echo $Seccion ?>" enctype="multipart/form-data">
        <?php
    }else{
        ?>
